...
export default function ComandaView({
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 h-[calc(100vh-140px)] overflow-hidden">
      ...
      <div className={`${activeMobileTab === 'comanda' ? 'flex flex-1 min-h-0' : 'hidden'} lg:flex lg:w-96 lg:flex-shrink-0 flex-col bg-white border border-slate-200 rounded-3xl p-5 shadow-sm overflow-hidden lg:h-full`}>
